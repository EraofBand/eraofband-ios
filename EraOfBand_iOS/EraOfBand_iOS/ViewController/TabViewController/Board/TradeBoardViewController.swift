//
//  TradeBoardViewController.swift
//  EraOfBand_iOS
//
...
class TradeBoardViewController: UIViewController{
...
extension TradeBoardViewController: UITableViewDataSource, UITableViewDelegate{
